...
extension LXSwiftBasics where Base : UISwitch {
    ...
    public func setHandle(switchCallBack: ((_ isOn: Bool?) -> ())?){
        base.switchCallBack = switchCallBack
