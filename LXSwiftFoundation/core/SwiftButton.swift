...
open class SwiftButton: UIButton {
    ...
    open func setTILayout(_ titleCallBack: SwiftButton.ButtonCallBack?,
                          _ imageCallBack: SwiftButton.ButtonCallBack?) {
        self.titleCallBack = titleCallBack
        self.imageCallBack = imageCallBack
    }
    
    open override func imageRect(forContentRect contentRect: CGRect) -> CGRect {
        imageCallBack?(contentRect) ?? contentRect
    }
    
    open override func titleRect(forContentRect contentRect: CGRect) -> CGRect {
        titleCallBack?(contentRect) ?? contentRect
    }
